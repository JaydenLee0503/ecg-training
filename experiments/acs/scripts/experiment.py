...
from experiments.acs.pipeline import digest_json, engineering_ids, extract_record, patient_split
...
CODE = ('experiments/acs/loader.py', 'experiments/acs/pipeline.py', 'ecgvmd/vmd.py',
        'ecgvmd/features.py', 'ecgvmd/scatter.py', 'ecgvmd/config.py',
        'ecgvmd/select.py', 'ecgvmd/quantum.py', 'ecgvmd/reupload.py',
        'experiments/acs/scripts/experiment.py', 'experiments/acs/provenance/layout_2026-09-24.json')
