...
from experiments.acs_omi_vmd_wst_vqc.loader import ACSDecision, ACSInfo, ACSRecord, LEADS
from experiments.acs_omi_vmd_wst_vqc.pipeline import (engineering_ids, extract_record, fit_preprocessor,
                                   make_classifiers, patient_split)
from experiments.acs_omi_vmd_wst_vqc.scripts import experiment as runner
...
class ACSExperimentTests(unittest.TestCase):
    ...
    def test_capped_vmd_is_logged_and_stops_instead_of_becoming_an_exclusion(self):
        ...
        with patch('experiments.acs_omi_vmd_wst_vqc.pipeline.vmd_batch', side_effect=capped):
    ...
    def test_both_frontends_receive_identical_physical_leads_and_order(self):
        ...
        with patch('experiments.acs_omi_vmd_wst_vqc.pipeline.vmd_batch', side_effect=converged):
